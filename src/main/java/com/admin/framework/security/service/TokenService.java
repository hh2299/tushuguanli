...
import com.admin.common.utils.ip.AddressUtils;
import com.admin.common.utils.ip.IpUtils;
...
public class TokenService
{
    ...
    public LoginUser getLoginUser(HttpServletRequest request)
    {
        ...
        if (StringUtils.isNotEmpty(token))
        {
            ...
            LoginUser user = localCache.get(userKey);
            return user;
        }
        return null;
    }
    ...
    public void refreshToken(LoginUser loginUser)
    {
        ...
        localCache.put(userKey, loginUser, expireTime, TimeUnit.MINUTES);
    }
